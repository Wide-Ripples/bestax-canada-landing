      ...
      <section className="w-full px-6 lg:px-10 py-10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            <Stars />
            <span className="text-sm font-bold text-[#333]">5.0 on Google &amp; Trustpilot</span>
          </div>
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          ...
          <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2 shadow-sm">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#00B67A"><path d="M12 0l2.545 7.826H22.5l-6.512 4.73 2.486 7.648L12 15.47l-6.474 4.734 2.486-7.648L1.5 7.826h7.955z"/></svg>
